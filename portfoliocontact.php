            ...
            <body>
                <?php  
                    if (isset($_SESSION['id'])){
                        ...
                        require('./backend/connect.php');
                         $query="SELECT email,address,pnum FROM public.users_info where email='$id'";
                ...
                ?>  
                    ...
                    <!-- Single Blog Area -->
                        ...
                        <?php
                        echo '<div class="main">';
                        echo '<div class="w3-padding-32 w3-content w3-text-grey" id="contact" style="margin-bottom:0px;margin-left:180px;width:fit-content;margin-right:50px">';
                        ...
                        echo  '<p><i class="fa fa-map-marker fa-fw w3-xxlarge w3-margin-right"></i>' .$address. '</p>';
                        echo   '<p><i class="fa fa-phone fa-fw w3-xxlarge w3-margin-right"></i> Phone:' .$pnum. '</p>';
                        echo   '<p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"> </i> Email:' .$email. '</p>';
                        $i=$i+1;
                        }
                        echo '</div>';
                        ?>
