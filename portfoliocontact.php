<!DOCTYPE html>
    ...
    <html>
        ...
        <body>
            ...
            <div class="main">
                <!-- Single Blog Area -->
                <div class="w3-padding-32 w3-content w3-text-grey" id="contact" style="margin-bottom:0px;margin-left:180px;margin-right:50px">
...
// console.log("latitude",latitude);
  var uluru = {lat: 39.1693999,lng: -86.4945909};
    ...
    var marker = new google.maps.Marker({position: uluru, map: map});
        ...
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAQmmzg6qwEu7XPe1tzXh5dSJtLlIurcfo&callback=initMap">
                    ...
                    <!-- <img class="w3-image w3-greyscale" style="width:100%;margin:32px 0"> -->
                    <!-- src="./W3.CSS Template_files/map.jpg"  -->
